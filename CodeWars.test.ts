import {
    ...
    sumPairs,
    orderWeight,
    orderWeightObj, pigIt, switchTest
} from './CodeWars';
...
describe('learning switches and for loops with a const', () => {
    it('tests the switch statement', () => {
        expect(switchTest([1, 2, 3, 4, 5, 'a', 'b', 'c', 'd', 'e'])).to.eql([4, 8, 'A', 'C', 'E'])
    })
})
